...
data_50_int_off = np.loadtxt("data_qsl_50_tau_int_off")
data_50_int_on = np.loadtxt("data_qsl_50_tau_int_on")

data_100_int_off = np.loadtxt("data_qsl_100_tau_int_off")
data_100_int_on = np.loadtxt("data_qsl_100_tau_int_on")

data_200_int_off = np.loadtxt("data_qsl_200_tau_int_off")
data_200_int_on = np.loadtxt("data_qsl_200_tau_int_on")

data_500_int_off = np.loadtxt("data_qsl_500_tau_int_off")
data_500_int_on = np.loadtxt("data_qsl_500_tau_int_on")
...
plt.savefig("qsl_1_qubit_with_tau.pdf")
plt.show()
