...
f_off = "2_qubit_local_int_off"

y_off = np.loadtxt(f_off, dtype=complex)

f_on = "2_qubit_local_int_on"
...
np.savetxt("tr_dist_2_qubit_local", data)

plt.plot(t, tr_dist_int_on_off, label="Trace distance 2 qubit local interaction on or off")
plt.legend()
plt.show()