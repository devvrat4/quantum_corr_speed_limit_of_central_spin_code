...
data_concur_discord_int_on = np.loadtxt("concur_discord_2_qubit_global_int_on")
data_concur_discord_int_off = np.loadtxt("concur_discord_2_qubit_global_int_off")

data_qsl_int_on = np.loadtxt("qsl_2_qubit_global_int_on")
data_qsl_int_off = np.loadtxt("qsl_2_qubit_global_int_off")
...
plt.savefig("global_2_qubit_qcorr_qsl_with_tau.pdf")
